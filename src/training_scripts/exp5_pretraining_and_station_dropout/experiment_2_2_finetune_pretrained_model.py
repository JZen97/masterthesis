# Experiment 5b) Finetune pretrained model
...
def train_model(model, model_save_path, model_name, train_dl, val_dl, val_dl_dropout, epochs, lr, checkpoint_path=None):
...
if __name__ == '__main__':
    ...
    # Paths
    meta_csv_path = '/fs/dss/work/lize4033/data/GraphInstance/events_meta_data.csv'
    distances_npy_path = '/fs/dss/work/lize4033/data/GraphInstance/station_distances_km.npy'
    h5_path = '/fs/dss/work/lize4033/data/GraphInstance/GraphInstance_events_gm.hdf5'
    train_path = '/fs/dss/work/lize4033/data/GraphInstance/GI_train.txt'
    val_path = '/fs/dss/work/lize4033/data/GraphInstance/GI_val.txt'
    test_path = '/fs/dss/work/lize4033/data/GraphInstance/GI_test.txt'
    ...
    # define model
    model = ModelExp5b().cuda()

    checkpoint = str(args.checkpoint)

    # load pretrained model weights
    weights_path = '/fs/dss/home/lize4033/masterthesis/development/experiments_2/experiment_2_1_pretraining_pga/'
    # get list of files
    files = os.listdir(weights_path)
    for file in files:
        if (file.endswith('_best.pt')) and (f'dropout_{dropout}' in file and not file.startswith('FT')):
    ...
    model_save_path = '/fs/dss/home/lize4033/masterthesis/development/experiments_2/experiment_2_2_finetune_pretrained_model/'
    model_name = f'ModelExp5b_lr{lr}_dropout_{dropout}'
    print(
        f'Starting Finetuning with Learning rate: {lr} for {epochs} epochs (dropout: {dropout}). \n==============================================')
    model = train_model(model, model_save_path, model_name, train_dl, val_dl, val_dl_dropout, epochs, lr, checkpoint_path=checkpoint)
    print('Finished Training.')
    #model, model_save_path, model_name, train_dl, val_dl, epochs, lr, checkpoint_path=
