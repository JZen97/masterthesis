# Experiment 2b) Maximum Graph Diameter
...
if __name__ == '__main__':
    ...
    model_exp_2b = ModelExp2b().cuda()
    epochs = args.epochs
    lr = args.lr
    checkpoint = str(args.checkpoint)
    model_save_path = 'adjust/this/path'
    model_name = f'ModelExp2b_graph_diameter_{k_hop_reachability}_lr{lr}'
    print(f'Starting Training with Learning rate: {lr} for {epochs} epochs (graph_format: {graph_format}) (k_hop_reachability: {k_hop_reachability}) (deterministic: {deterministic}). \n==============================================')
    model = train_model(model_exp_2b, model_save_path, model_name, train_dl, val_dl, epochs, lr, checkpoint_path=checkpoint)
